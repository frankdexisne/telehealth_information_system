...
const TransferedDepartment = () => {
  ...
  const { data, pagination, isFetching, changePage } = useTable({
    endpoint: "consultations/triaged-consultations",
    pageSize: 10,
    parameters: debouncedParameters,
  });

  const columns: ColumnDefinition<TransferedRowData>[] = [
    {
...
export default TransferedDepartment;
